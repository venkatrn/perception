...
device_vector_holder<int> render_cuda_multi(
    ...
    //     int rendered_cloud_point_num = mask.back() + mask_back_temp;
    ...
    //     // float* result_cloud = (float*) malloc(point_dim * rendered_cloud_point_num * sizeof(float));
    //     // float* result_cloud_color = (uint8_t*) malloc(point_dim * rendered_cloud_point_num * sizeof(uint8_t));
    //     // int* dc_index = (int*) malloc(num_images * width * height * sizeof(int));
    //     // int* cloud_pose_map = (int*) malloc(rendered_cloud_point_num * sizeof(int));
