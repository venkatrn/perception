...
perch_bin = ros_pack.get_path('sbpl_perception') + '/bin/experiments/perch'
...
for subdir, dirs, files in os.walk(config_dir):
    ...
    for file in files:
        ...
        command = [perch_bin, config_file_path, pose_file, stats_file]
        # print command
        subprocess.call([perch_bin, config_file_path, pose_file, stats_file])
